...
public final class PoolMetrics {
    ...
    private final Counter producerRecoveryCounter;
    ...
    public PoolMetrics(MeterRegistry registry,
        ...
        this.producerFencedCounter = Counter.builder("producer_fenced_total")
                ...
                .register(registry);
        this.producerRecoveryCounter = Counter.builder("producer_recovery_total")
                .description("Number of producer recovery attempts")
                .register(registry);
    }
    ...
    public void recordProducerRecovery() {
        producerRecoveryCounter.increment();
    }
